    ...
    '/',
    {
      ...
      schema: {
        ...
        description:
          ...
          'Campos de texto (multipart, todos obrigatórios): `type` (um de `LOST`, `FOUND`, `DONATION`); `title` (string não vazia); `description` (string não vazia); `species` (um de `DOG`, `CAT`, `BIRD`); `latitude` e `longitude` (números); `city` (string não vazia). Além disso, uma ou mais partes de arquivo com a foto do pet (qualquer nome de campo — cada parte do tipo arquivo recebida é tratada como uma foto).\n\n' +
